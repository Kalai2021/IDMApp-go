...
echo "Testing Update and Delete Operations on Existing User"
echo "===================================================="
...
# Test 2: Get all users to find an existing user ID
echo -e "\n2. Get all users to find an existing user ID:"
...
# Test 3: Get the specific user
echo -e "\n3. Get the specific user:"
...
echo -e "\n🎉 Update and Delete Operations Test Completed!" 